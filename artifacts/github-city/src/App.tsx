        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {/* X / Twitter account button */}
              <a
                href="https://x.com/jackie_doll96"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full no-underline transition-all duration-200"
                style={{
              ...
              >
                <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" style={{ color: 'rgba(255,255,255,0.55)', flexShrink: 0 }}>
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.254 5.622 5.91-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
                <span className="text-[11px] font-medium text-white/55" style={{ letterSpacing: '0.04em' }}>
                  @jackie_doll96
                </span>
              </a>
            </div>
